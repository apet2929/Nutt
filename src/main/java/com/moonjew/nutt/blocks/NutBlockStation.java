...
public class NutBlockStation extends NutBlock{
    private Container container;
    private TileEntity entity;
    public NutBlockStation(String name, Material materialIn, TileEntity tileEntity) {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new TileEntity(entity.getType()){};
    }
